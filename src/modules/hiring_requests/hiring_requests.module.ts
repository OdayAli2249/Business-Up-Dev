...
@Module({
  ...
  providers: [HiringRequestService, HiringRequestDataSourceImpl, HiringRequestRepositoryImpl, HiringRequestHandlersWrapper, HiringRequestValidatorsWrapper, HiringRequestValidatorImpl, Db]
})
