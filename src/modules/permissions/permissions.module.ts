...
@Module({
  ...
  providers: [PermissionService, PermissionDataSourceImpl, PermissionRepositoryImpl, PermissionHandlersWrapper, PermissionValidatorImpl, PermissionValidatorsWrapper,Db]
})
