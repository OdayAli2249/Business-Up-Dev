...
import { ServiceHandlerImpl } from './inspectors/handlers/service_handler_impl/service_handler_impl';
...
@Module({
  exports: [ServiceHandlerImpl, ServiceValidatorImpl, ServiceDataSourceImpl, ServiceRepositoryImpl, ServiceValidatorsWrapper, ServiceHandlersWrapper],
  providers: [ServiceHandlerImpl, ServiceValidatorImpl, ServiceDataSourceImpl, ServiceRepositoryImpl, ServiceValidatorsWrapper, ServiceHandlersWrapper, Db]
})
