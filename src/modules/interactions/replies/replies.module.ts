...
import { ReplyHandlerImpl } from './inspectors/handlers/reply_handler_impl/reply_handler_impl';
...
@Module({
  exports: [ReplyRepositoryImpl, ReplyDataSourceImpl, ReplyHandlerImpl, ReplyValidatorImpl, ReplyValidatorsWrapper, ReplyHandlersWrapper],
  providers: [ReplyRepositoryImpl, ReplyDataSourceImpl, ReplyHandlerImpl, ReplyValidatorImpl, ReplyValidatorsWrapper, ReplyHandlersWrapper,Db]
})
