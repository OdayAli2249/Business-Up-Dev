...
import { CommentHandlerImpl } from './inspectors/handlers/comment_handler_impl/comment_handler_impl';
...
@Module({
  exports: [CommentRepositoryImpl, CommentDataSourceImpl, CommentHandlerImpl, CommentValidatorImpl, CommentValidatorsWrapper, CommentHandlersWrapper],
  providers: [CommentRepositoryImpl, CommentDataSourceImpl, CommentHandlerImpl, CommentValidatorImpl, CommentValidatorsWrapper, CommentHandlersWrapper,Db]
})
