...
import { OrderHandlerImpl } from './inspectors/handlers/order_handler_impl/order_handler_impl';
...
@Module({
  ...
  providers: [OrderService, OrderValidatorImpl, OrderHandlerImpl, OrderDataSourceImpl, OrderRepositoryImpl, OrderValidatorsWrapper, OrderHandlersWrapper,Db]
})
