...
import { BranchHandlerImpl } from './inspectors/handlers/branch_handler_impl/branch_handler_impl';
...
@Module({
  ...
  providers: [BranchService, BranchDataSourceImpl, BranchRepositoryImpl, BranchHandlerImpl, BranchValidatorImpl, BranchValidatorsWrapper, BranchHandlersWrapper, Db]
})
